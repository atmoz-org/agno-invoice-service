...
GEMINI_MODELS=[
    "gemini-2.0-flash", "gemini-2.0-flash-lite","gemini-2.5-pro-exp-03-25", "gemini-2.0-flash-thinking-exp-1219",
]
...
def get_gemini_models():
    """Return the list of Gemini model IDs available for selection."""
...
def switch_model(provider: str, model_choice: str):
    ...
    if provider.lower() == "openai":
        ...
        agent.model = Gemini(id=model_choice,  project_id="91901510074")
    else:
